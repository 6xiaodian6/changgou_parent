...
public class RabbitMQConfig {
    ...
    public static final String GOODS_PAGE_CREATE_EXCHANGE = "goods_page_create_exchange";
    ...
    @Bean(GOODS_PAGE_CREATE_EXCHANGE)
    public Exchange GOODS_PAGE_CREATE_EXCHANGE(){
        return ExchangeBuilder.fanoutExchange(GOODS_PAGE_CREATE_EXCHANGE).durable(true).build();
    }
    ...
    @Bean
    public Binding GOODS_PAGE_CREATE_EXCHANGE_BINDING(@Qualifier(PAGE_CREATE_QUEUE) Queue queue,@Qualifier(GOODS_PAGE_CREATE_EXCHANGE) Exchange exchange){
        return BindingBuilder.bind(queue).to(exchange).with("").noargs();
    }
}